...
public class MxGraph {
    ...
    public void createGraph(int numOfNodes, int numOfEdges, int[][] edgeCapacity) {
        ...
        infoLabel.setText("<html><font color='red'>Normal Flow in Red</font> &nbsp; <font color='blue'>Last Flow in Blue</font></html>");
        infoLabel.setFont (maxFlowLabel.getFont ().deriveFont (20.0f));
